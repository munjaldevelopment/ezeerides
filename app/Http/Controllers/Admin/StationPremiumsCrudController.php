...
use App\Http\Requests\StationPremiumsRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class StationPremiumsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class StationPremiumsCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\StationPremiums::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/stationpremiums');
        CRUD::setEntityNameStrings('Station Premiums', 'Station Premiums');
        ...
        $this->crud->setCreateView('admin.create-station-premiums-form');
        $this->crud->setUpdateView('admin.edit-station-premiums-form');
    ...
    {
        CRUD::setValidation(StationPremiumsRequest::class);
