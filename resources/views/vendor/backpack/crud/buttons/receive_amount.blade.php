...
<script>
	...
	if (typeof recceiveAmountEntry != 'function') {
	  $("[data-button-type=receive]").unbind('click');

	  function recceiveAmountEntry(button) {
	...
	// crud.addFunctionToDataTablesDrawEventQueue('recceiveAmountEntry');
</script>
